...
def register(username, password):
    ...
    if existing_user:
        ...
        runsim()  # Execute runsim() only when a new user is registered successfully
...
def main():
    ...
    while True:
        ...
        pygame.draw.rect(screen, WHITE, username_box, 2 if username_active else 1)
        pygame.draw.rect(screen, WHITE, password_box, 2 if password_active else 1)
        pygame.draw.rect(screen, WHITE, register_button_rect, 2 if register_active else 1)
        pygame.draw.rect(screen, WHITE, login_button_rect, 2 if login_active else 1)
