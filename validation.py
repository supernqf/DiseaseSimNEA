import pygame
import pygame
def get_valid_inputs(screen, prompt_integer, prompt_infection, prompt_death_rate, font, color, input_box_rect_integer, input_box_rect_infection, input_box_rect_death_rate):
          ...
          if event.type == pygame.QUIT:
              ...
              if event.key == pygame.K_RETURN and active == "integer":
                  try:
                      ...
                      input_str_integer = ''
                      base_surface_integer = font.render(prompt_integer + " (Please enter a valid integer)", True, color)
                  ...
                  try:
                      ...
                      if 0 <= value_infection <= 1:
                          ...
                          input_str_infection = ''
                          base_surface_infection = font.render(prompt_infection + " (Please enter a value between 0 and 1)", True, color)
                  except ValueError:
                      input_str_infection = ''
                      base_surface_infection = font.render(prompt_infection + " (Please enter a valid float)", True, color)
                  ...
                  try:
                      ...
                      if 0 <= value_death_rate <= 1:
                          ...
                          input_str_death_rate = ''
                          base_surface_death_rate = font.render(prompt_death_rate + " (Please enter a value between 0 and 1)", True, color)
                  except ValueError:
                      input_str_death_rate = ''
                      base_surface_death_rate = font.render(prompt_death_rate + " (Please enter a valid float)", True, color)
